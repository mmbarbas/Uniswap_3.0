...
const style = {
    ...
    nav:`felx-1 flex justify-center items-center`,
    ...
    <div className={style.wrapper}>
        ...
        <div className={style.nav}>
            <div className={style.navItemsContainer}>
                ...
                className={`${style.navItem} ${selectedNav === 'swap' && style.activeNavItem}`} >Swap</div>
                <div 
                onClick={()=>setSelectedNav('pool')} 
                className={`${style.navItem} ${selectedNav === 'pool' && style.activeNavItem}`} >Pool</div>
                <div 
                onClick={()=>setSelectedNav('vote')}
                className={`${style.navItem} ${selectedNav === 'vote' && style.activeNavItem}`}>Vote</div>
